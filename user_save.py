    ...
    def run_script():
        ...
        while element_back == True:
            try:
                ...
                try:
                    # اختيار المديه الاسكندريه او القاهره
                ...
                Select_service_level2s = driver.find_elements(By.XPATH,".//mat-option")
                ...
                # الضغط على علامتين صح
                mark_accept = driver.find_element(By.ID,"mat-mdc-checkbox-1-input")
                mark_accept.click()
                mark_accept1 = driver.find_element(By.ID,"mat-mdc-checkbox-2-input")
                mark_accept1.click()
                # print("here")
                element_found = False
                max_attemps = 12
                attemps = 0
                # الضغط على زر الموافقه بعدد 12 مره
                while not element_found and attemps < max_attemps:
                    try:


                        # اخر زر فى الصفحه الاولى
                        # print("here2")/html/body/app-root/div/app-appointment-page/div/mat-stepper/div/div[2]/div[1]/app-memebers-number/app-visasys-allert-card/div[2]/div[3]/button
                        ...
                        # زر انه تمت الموافقه وانه سيتم الحجز
                        ...
                        # اول زر فى الصفحه الثانيه اللى هيفتح الاختيارات
                        ...
                        # اعاده التكرار لو متمش الحجز
                        # print("not found")
                        time.sleep(1)
                        attemps += 1
                    if attemps == max_attemps:
                        # الرساله التى تفيد بانه لم يتم الحجز
            ...
            time.sleep(1.5)
            select_gender = driver.find_element(By.XPATH,"/html/body/div[2]/div[4]/div")
            ...
            #صوره الباسبور
            time.sleep(1.5)
            passport_labels = driver.find_elements(By.XPATH,".//label")
            for passport_label in passport_labels:
                passport_label_text = passport_label.text
                if passport_label_text == "Browse":
                    passport_label.click()
